...
standimage.src="/img/dinosaur.png";

var cactus=new Image();
cactus.src="/img/cactus.png";

var cactus2image=new Image();
cactus2image.src="/img/cactus2.png";

var flyingdinosaur=new Image();
flyingdinosaur.src="/img/flyingdinosaur.png";
...
var scoreText={
  ...
  update:function(text){
    ...
    gamearea.context.font="30px Impact";
    gamearea.context.fillText(text,10,42);
  }
}
var player={
  x:20,
...
function obstacle(){
  this.height=Math.floor(20+Math.random()*(60-20+1));
...
var gamearea={
  ...
  stop:function(){
    ...
    gamearea.context.fillStyle="black";
    gamearea.context.font="50px Impact";
    gamearea.context.fillText("GAME OVER",350,250);	
  },
}
